 ...
 */
//===================================================================
public class DESCrypto extends PBECrypto
//===================================================================
{

   private static final String _passPhrase = "Project Open_Provisioning_ToolKit-2.0";
   private static final String _cipher = "PBEWithMD5AndDES";

   /**
    * Creates a CryptoIF instance 
    * using the PBEWithMD5AndDES cipher with a pre-defined pass phrase.
    * 
   ...
   //----------------------------------------------------------------
   {
      super(DESCrypto._passPhrase, DESCrypto._cipher);
      return;
   }
    ...
    */
   //----------------------------------------------------------------
   public DESCrypto(final String passPhrase) throws CryptoException
   //----------------------------------------------------------------
   {
      super(passPhrase, DESCrypto._cipher);
      return;
   }
