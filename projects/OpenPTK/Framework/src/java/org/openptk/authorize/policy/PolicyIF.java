 ...
 */
//===================================================================
public interface PolicyIF extends ComponentIF
//===================================================================
{

   public Map<String, TargetIF> getTargets();

   public void addTarget(String id, TargetIF target);

   public TargetIF getTarget(String id);
