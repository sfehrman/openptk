...
/*
 * This "authenticator" uses the specified Context to validate the
 * provided unique id.  A READ Operation is performed against the
 * Context (using the id).  If the operation is successful, the
 * authentication is successful (true is returned). Else, false is returned
 */
//===================================================================
public class IdServiceAuthenticator extends Authenticator
//===================================================================
{
   private final String CLASS_NAME = this.getClass().getSimpleName();

   //----------------------------------------------------------------
   public IdServiceAuthenticator()
   //----------------------------------------------------------------
   {
      super();
