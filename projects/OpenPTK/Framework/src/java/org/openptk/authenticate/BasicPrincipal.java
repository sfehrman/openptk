...
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public BasicPrincipal(final CredentialsIF creds)
   //----------------------------------------------------------------
   {
      super(creds);
      
      this.setDescription("Basic Principal");
    ...
    */
   //----------------------------------------------------------------
   public BasicPrincipal(final PrincipalIF principal)
   //----------------------------------------------------------------
   {
      super(principal);
   ...
   /**
    * Makes a copy of the BasicPrincipal.
    * @return PrincipalIF
    */
   //----------------------------------------------------------------
   @Override
