 ...
 */
//===================================================================
public class SubjectRelationship extends Relationship
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public SubjectRelationship(final Query query)
   //----------------------------------------------------------------
   {
      super(query);
      return;
   ...
   //----------------------------------------------------------------
   {
      ...
      this.handleError(METHOD_NAME + "Operation not implemented");
      return output;
   }
