...
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public ContextResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":ContextResource(): ";
      String msg = null;
    ...
    * @return
    */
   @Path("/"+ StructureIF.NAME_SUBJECTS)
   //----------------------------------------------------------------
   public SubjectsResource getSubjects()
   //----------------------------------------------------------------
   {
      SubjectsResource resource = null;

      resource = new SubjectsResource(_ctx, _uri, _struct);
