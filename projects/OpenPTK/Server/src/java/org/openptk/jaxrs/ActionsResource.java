...
//===================================================================
public class ActionsResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public ActionsResource(@Context ServletContext ctx, @Context UriInfo uri)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
    ...
    */
   //----------------------------------------------------------------
   public ActionsResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":ActionsResource(): ";
      String msg = null;
      ...
      _type = RepresentationType.ACTION;
      _struct = struct;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_ACTIONID + "}")
   //----------------------------------------------------------------
   public ActionResource getActionResource(@PathParam(StructureIF.NAME_ACTIONID) String actionId)
   //----------------------------------------------------------------
   {
      ActionResource resource = null;

      resource = new ActionResource(_ctx, _uri, _struct);
