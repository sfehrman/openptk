 ...
 */
//===================================================================
public class ModelsResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public ModelsResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":ModelsResource(): ";
      String msg = null;
      ...
      _type = RepresentationType.MODEL;
      _struct = struct;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_MODELID + "}")
   //----------------------------------------------------------------
   public ModelResource getModelResource(@PathParam(StructureIF.NAME_MODELID) String modelId)
   //----------------------------------------------------------------
   {
      ModelResource resource = null;

      resource = new ModelResource(_ctx, _uri, _struct);
