 ...
 */
//===================================================================
public class CachesResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public CachesResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":CachesResource(): ";
      String msg = null;
      ...
      _type = RepresentationType.CACHE;
      _struct = struct;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_CACHEID + "}")
   //----------------------------------------------------------------
   public CacheResource getCacheResource(@PathParam(StructureIF.NAME_CACHEID) String cacheId)
   //----------------------------------------------------------------
   {
      CacheResource resource = null;

      resource = new CacheResource(_ctx, _uri, _struct);
