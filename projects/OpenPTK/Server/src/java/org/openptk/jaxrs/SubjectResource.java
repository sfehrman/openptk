...
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public SubjectResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":SubjectResource(): ";
      String msg = null;
    ...
    * @return
    */
   @Path("/" + StructureIF.NAME_PASSWORD)
   //----------------------------------------------------------------
   public PasswordResource getPasswordResource()
   //----------------------------------------------------------------
   {
      PasswordResource resource = null;

      resource = new PasswordResource(_ctx, _uri, _struct);
    ...
    * @return
    */
   @Path("/" + StructureIF.NAME_RELATIONSHIPS)
   //----------------------------------------------------------------
   public RelationshipsResource getRelationshipsResource()
   //----------------------------------------------------------------
   {
      RelationshipsResource resource = null;

      resource = new RelationshipsResource(_ctx, _uri, _struct);
    ...
    * @return
    */
   @Path("/" + StructureIF.NAME_VIEWS)
   //----------------------------------------------------------------
   public ViewsResource getViewsResource()
   //----------------------------------------------------------------
   {
      ViewsResource resource = null;

      resource = new ViewsResource(_ctx, _uri, _struct);
