...
//===================================================================
public class ClientsResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public ClientsResource(@Context ServletContext ctx, @Context UriInfo uri)
   //----------------------------------------------------------------
   {
      super(ctx, uri);

      _type = RepresentationType.CLIENT;
    ...
    */
   //----------------------------------------------------------------
   public ClientsResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_CLIENTID + "}")
   //----------------------------------------------------------------
   public ClientResource getClientResource(@PathParam(StructureIF.NAME_CLIENTID) String clientId)
   //----------------------------------------------------------------
   {
      ClientResource resource = null;

      resource = new ClientResource(_ctx, _uri, _struct);
