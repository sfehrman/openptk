 ...
 */
//===================================================================
public class ConverterResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public ConverterResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":ConverterResource()";
      String msg = null;
