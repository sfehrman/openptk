...
//===================================================================
public class EnforcersResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public EnforcersResource(@Context ServletContext ctx, @Context UriInfo uri)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
    ...
    */
   //----------------------------------------------------------------
   public EnforcersResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":EnforcersResource(): ";
      String msg = null;
      ...
      _type = RepresentationType.ENFORCER;
      _struct = struct;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_ENFORCERID + "}")
   //----------------------------------------------------------------
   public EnforcerResource getEnforcerResource(@PathParam(StructureIF.NAME_ENFORCERID) String enforcerId)
   //----------------------------------------------------------------
   {
      EnforcerResource resource = null;

      resource = new EnforcerResource(_ctx, _uri, _struct);
