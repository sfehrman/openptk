 ...
 */
//===================================================================
public class AttrMapsResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public AttrMapsResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      ...
      _type = RepresentationType.ATTRMAP;
      _struct = struct;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_ATTRMAPID + "}")
   //----------------------------------------------------------------
   public AttrMapResource getAttrMapResource(@PathParam(StructureIF.NAME_ATTRMAPID) String attrmapId)
   //----------------------------------------------------------------
   {
      AttrMapResource resource = null;

      resource = new AttrMapResource(_ctx, _uri, _struct);
