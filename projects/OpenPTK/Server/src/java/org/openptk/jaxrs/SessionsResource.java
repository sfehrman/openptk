...
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public SessionsResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":SessionsResource(): ";
      String msg = null;
      ...
      _type = RepresentationType.SESSION;
      _struct = struct;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_SESSIONID + "}")
   //----------------------------------------------------------------
   public SessionResource getSessionResource(@PathParam(StructureIF.NAME_SESSIONID) String sessionId)
   //----------------------------------------------------------------
   {
      SessionResource resource = null;

      resource = new SessionResource(_ctx, _uri, _struct);
