...
//===================================================================
public class PoliciesResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public PoliciesResource(@Context ServletContext ctx, @Context UriInfo uri)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
    ...
    */
   //----------------------------------------------------------------
   public PoliciesResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":PoliciesResource(): ";
      String msg = null;
      ...
      _type = RepresentationType.POLICY;
      _struct = struct;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_POLICYID + "}")
   //----------------------------------------------------------------
   public PolicyResource getPolicyResource(@PathParam(StructureIF.NAME_POLICYID) String policyId)
   //----------------------------------------------------------------
   {
      PolicyResource resource = null;

      resource = new PolicyResource(_ctx, _uri, _struct);
