...
//===================================================================
public class PluginsResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public PluginsResource(@Context ServletContext ctx, @Context UriInfo uri)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
    ...
    */
   //----------------------------------------------------------------
   public PluginsResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":PluginsResource(): ";
      String msg = null;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_PLUGINID + "}")
   //----------------------------------------------------------------
   public PluginResource getPluginResource(@PathParam(StructureIF.NAME_PLUGINID) String clientId)
   //----------------------------------------------------------------
   {
      PluginResource resource = null;

      resource = new PluginResource(_ctx, _uri, _struct);
