...
//===================================================================
public class ContextsResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public ContextsResource(@Context ServletContext ctx, @Context UriInfo uri)
   //----------------------------------------------------------------
   {
      super(ctx, uri);

      _type = RepresentationType.CONTEXT;
    ...
    */
   //----------------------------------------------------------------
   public ContextsResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":ContextsResource(): ";
      String msg = null;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_CONTEXTID + "}")
   //----------------------------------------------------------------
   public ContextResource getContextResource(@PathParam(StructureIF.NAME_CONTEXTID) String contextId)
   //----------------------------------------------------------------
   {
      ContextResource resource = null;

      resource = new ContextResource(_ctx, _uri, _struct);
