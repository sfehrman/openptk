...
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public SessionResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":SessionResource()";
      String msg = null;
    ...
    * @return
    */
   @Path("/" + StructureIF.NAME_CACHES)
   //----------------------------------------------------------------
   public CachesResource getCaches()
   //----------------------------------------------------------------
   {
      CachesResource resource = null;

      resource = new CachesResource(_ctx, _uri, _struct);
