 ...
 */
//===================================================================
public class ViewsResource extends Resource
//===================================================================
{
    ...
    */
   //----------------------------------------------------------------
   public ViewsResource(ServletContext ctx, UriInfo uri, StructureIF struct)
   //----------------------------------------------------------------
   {
      super(ctx, uri);
      String METHOD_NAME = CLASS_NAME + ":ViewsResource(): ";
      String msg = null;
    ...
    * @return
    */
   @Path("/{" + StructureIF.NAME_VIEWID + "}")
   //----------------------------------------------------------------
   public ViewResource getViewResource(@PathParam(StructureIF.NAME_VIEWID) String viewId)
   //----------------------------------------------------------------
   {
      ViewResource resource = null;

      resource = new ViewResource(_ctx, _uri, _struct);
