...
//===================================================================
{
   ...
   private String CLIENTSECRET = "McP7NoBoPTPHrJZLfXsnDEod"; //gKZo9rUyLeY56vSsFpR4J9GJ  -  McP7NoBoPTPHrJZLfXsnDEod
   private String AUTHENTICATOR = "Employees-IdPass-JDBC"; // from CONFIG - Authenticator
   private String UNIQUEID_TOKEN_NAME = "user"; // from Global properties
   private String PASSWORD_TOKEN_NAME = "password"; // from Global properties
   private String UNIQUEID = "ja1324"; // good = eapi
   private String PASSWORD = "Passw0rd"; // good = Sun123abc
   ...
   //----------------------------------------------------------------
   {
      testIdPassAuthenticator test = new testIdPassAuthenticator();
   ...
   //----------------------------------------------------------------
   {
      ...
      try
      {
         ...
         authInfo.put(PASSWORD_TOKEN_NAME, crypto.encrypt(PASSWORD));
