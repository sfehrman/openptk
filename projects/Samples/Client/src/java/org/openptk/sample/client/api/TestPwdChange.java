...
//===================================================================
{
   ...
   //----------------------------------------------------------------
   {
      TestPwdChange test = new TestPwdChange();
   ...
   //----------------------------------------------------------------
   {
      ...
      output = connection.execute(Opcode.PWDCHANGE, input);

      if (output != null)
      {
         System.out.println("Password Change Output: " + output.getStatus());
      }
