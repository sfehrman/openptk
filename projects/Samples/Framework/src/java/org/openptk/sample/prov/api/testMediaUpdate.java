...
//===================================================================
class testMediaUpdate extends apiTest
//===================================================================
{
   //----------------------------------------------------------------
   ...
   //----------------------------------------------------------------
   {
      testMediaUpdate test = new testMediaUpdate();
   ...
   //----------------------------------------------------------------
   {
      ...
      file = new File("/Users/sfehrman/Desktop/focus-rectangle.png");
      //file = new File("/Users/sfehrman/Desktop/Java_Jersey_Client.pdf");
      ...
      input.addAttribute("type"); // work-around, force the Function to run
      input.addAttribute("modified"); // work-around, force the Function to run
      input.addAttribute("digest"); // work-around, force the Function to run
