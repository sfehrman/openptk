...
import com.sun.idm.rpc.spml2.SessionAwareSpml2Client;
 ...
 */
//===================================================================
public class ClientFacadeWaveset extends ClientFacade
//===================================================================
{
   private final String CLASS_NAME = this.getClass().getSimpleName();
   private SessionAwareSpml2Client _client = null;

   //----------------------------------------------------------------
   public ClientFacadeWaveset()
   //----------------------------------------------------------------
   {
      super();
      return;
   ...
   //----------------------------------------------------------------
   {
      ...
      {
         _client = new SessionAwareSpml2Client(_url, _username, _password);
      }
      else
      {
         _client = new SessionAwareSpml2Client(_url);
      }
