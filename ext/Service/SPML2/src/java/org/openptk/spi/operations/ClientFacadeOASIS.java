 ...
 */
//===================================================================
public class ClientFacadeOASIS extends ClientFacade
//===================================================================
{
   private final String CLASS_NAME = this.getClass().getSimpleName();
   private Spml2Client _client = null;

   //----------------------------------------------------------------
   public ClientFacadeOASIS()
   //----------------------------------------------------------------
   {
      super();
      return;
   ...
   //----------------------------------------------------------------
   {
      ...
      {
         _client = new Spml2Client(_url, _username, _password);
      }
      else
      {
         _client = new Spml2Client(_url);
      }
